...
void top_cnn_mancini(led_type cifar_class[1], image_type image_in[CNN_IMAGE_SIZE*3], image_type cifar_probabilities[NCAN_OUT_5]){
    ...
    perceptron(Matrice1,MATRICE_LOCAL3_WEIGHTS,MATRICE_LOCAL3_BIAS,cifar_probabilities,NCAN_IN_5,NCAN_OUT_5);
